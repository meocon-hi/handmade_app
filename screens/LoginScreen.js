  ...
  return (
    ...
    >
      ...
      /> 
          ...
          <Text style={{ fontSize: 20, color: "#662d91", fontWeight: "bold" ,marginTop:20}}>
            Sign In
          </Text>
        ...
        <View style={{ marginTop: 50 }}>
          ...
          <Pressable onPress={() => navigation.navigate("Login2")} style={{ marginTop: 20 }}>
            <Text
              style={{
                textAlign: "center",
                fontSize: 17,
...
const styles = StyleSheet.create({
  avatar: {
    width: 220, // Increase width if necessary
    height: 220, // Increase height if necessary
